...
export default function Hero() {
  ...
  <div className="swap-on flex items-center justify-center w-20 rounded-xl">PLAY<FaPlay className="ml-4"/></div>
  <div className="swap-off flex items-center justify-center w-20 rounded-xl">PAUSE<FaPause className="ml-4"/></div>
</label>
