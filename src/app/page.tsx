        ...
        <main>
            <div className="bg-dark-gradient m-0 mb-0 flex h-fit flex-col-reverse items-center justify-center bg-black bg-cover bg-center bg-no-repeat object-cover sm:h-screen sm:flex-row">
                ...
                <BackgroundGradientAnimation
                    ...
                    size="100%"
                >
                    <div className="absolute left-[40%] top-1/2 z-50 -translate-x-1/2 -translate-y-1/2 transform text-left text-8xl lg:text-9xl text-white mix-blend-screen md:left-[42%] lg:left-[50%]">
